      ...
      <div className="container" style={{backgroundColor:'whitesmoke'}}>
        ...
        <div className="indexInfo" style={{display:'flex', justifyContent:'space-evenly', alignItems: 'center', flexGrow:'1'}}>
          ...
          <div className="infoText" style={{alignContent: 'center', padding: '10pt', backgroundColor: 'white', opacity: '1', width:'600px', borderRadius: '5pt' }}>
            <div>Little Brothers Friends of the Elderly</div>
            <p>Since 1959, Little Brothers – Friends of the Elderly, Chicago Chapter’s mission, philosophy, programs and activities remain focused on alleviating loneliness and isolation among elders. Social interaction is critical to the human spirit — we believe that nurturing the soul is as important as feeding the body. </p>
          </div>
        </div>  
      </div>
